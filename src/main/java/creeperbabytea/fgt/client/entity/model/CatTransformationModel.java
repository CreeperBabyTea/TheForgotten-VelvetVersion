package creeperbabytea.fgt.client.entity.model;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.mojang.blaze3d.vertex.IVertexBuilder;
import creeperbabytea.fgt.common.spell.CatTransformingCharm.CatTransformationEntity;
...
public class CatTransformationModel extends EntityModel<CatTransformationEntity> {
    ...
    public void setRotationAngles(CatTransformationEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        setRotationAngle(ears, ears.rotateAngleX, ears.rotateAngleY + entity.rotationPitch, ears.rotateAngleZ + entity.rotationYaw);
        setRotationAngle(tails, ears.rotateAngleX, ears.rotateAngleY + entity.rotationPitch, ears.rotateAngleZ + entity.rotationYaw);
        //TODO
    }
